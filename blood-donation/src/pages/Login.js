...
// // //new one with added featueres like forget and reset password 
// // // and also added the loader and error message and also added the register link and forgot password link and also added the email and password validation and also added the login button and also added the register button and also added the login form and also added the register form and also added the login page and also added the register page and also added the login component and also added the register component and also added the login css file and also added the register css file and also added the login js file and also added the register js file and also added the login html file and also added the register html file
// // import React, { useState } from "react";
// // import axios from "axios"; 
// // import Button from "react-bootstrap/Button";
// // import Form from "react-bootstrap/Form";
      ...
      <div className="login-container">
        <div className="login-section">
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <div className="forgot-password-link">
               <Link to="/forgot-password" style={{ color: '#e74c3c' }}>Forgot Password?</Link>
            </div>
